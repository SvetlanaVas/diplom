...
* **Фактический результат**: после нажатия кнопки "Продолжить" текст на ней поменялся на "Отправляем запрос в банк". По окончании появляется сообщение: "Успешно. Операция одобрена банком"
...
* **Фактический результат:** поле Номер карты не заполняется, под ним появляется  текст "Неверный формат". Тест упал.
...
## Негативные сценарии:
**1.** Отправить заявку в случае приобретения тура с оплатой дебетовой картой с именем и фамилией "Владельца" кириллицей.
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
...
**2.** Отправить заявку в случае приобретения тура с оплатой в кредит с именем и фамилией "Владельца" кириллицей.
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить в кредит"
* Заполнить поля валидными данными, поле "Владелец" заполнить кириллицей, кликнуть  кнопку "Продолжить"
* **Ожидаемый результат:** под полем "Владелец" появляется сообщение "Неверный формат"
...
**3 .** Отправить заявку с пустым полем "Номер карты"
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
...
**4.** Отправить заявку с пустым полем "Месяц"
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить в кредит"
...
**5.** Отправить заявку с полем "Месяц" равному предыдущему месяцу
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
* Заполнить поля валидными данными, в поле "Месяц" автоматически  вводится предыдущий месяц, в поле "Год" ввести "20", кликнуть  кнопку "Продолжить"
* **Ожидаемый результат:** появляется сообщение "Неверно указан срок действия карты"
* **Фактический результат:** появляется сообщение "Неверно указан срок действия карты"

**6.** Отправить заявку с пустым полем "Год"
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить в кредит"
* Заполнить поля валидными данными, поле "Месяц" оставить пустым, кликнуть  кнопку "Продолжить"
* **Ожидаемый результат:** появляется сообщение "Неверный формат"
...
**7.** Отправить заявку с пустым полем "Владелец"
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить в кредит"
...
**8.** Отправить заявку с пустым полем "CVC/CVV"
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить в кредит"
* Заполнить поля валидными данными, поле "Владелец" оставить пустым, кликнуть  кнопку "Продолжить"
* **Ожидаемый результат:** появляется сообщение "Неверный формат"
...
**9.** Отправить заявку с кодом CVC/CVV из одной цифры
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
