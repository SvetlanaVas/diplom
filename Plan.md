...
**5.** Отправить заявку с пустым полем "Год"
* Открыть в браузере  http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
* Заполнить поля валидными данными, поле "Месяц" оставить пустым, кликнуть  кнопку "Продолжить"
* Ожидаемый результат: появляется сообщение "Неверный формат"

**6.** Отправить заявку с пустым полем "Владелец"
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
...
**7.** Отправить заявку с пустым полем "CVC/CVV"
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
* Заполнить поля валидными данными, поле "Владелец" оставить пустым, кликнуть  кнопку "Продолжить"
* Ожидаемый результат: появляется сообщение ""Неверный формат""

**8.** Отправить заявку с кодом CVC/CVV из одной цифры
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
* Заполнить поля валидными данными, в поле "CVC/CVV" ввести  цифру 7, кликнуть кнопку "Продолжить"
* Ожидаемый результат: появляется сообщение ""Неверный формат""

**9.** Отправить заявку с текстом вместо номера карты
* Открыть в браузере http://localhost:8080/
* На главной странице кликнуть кнопку "Купить"
